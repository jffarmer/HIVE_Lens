...
//************OLD DEPRACATED BANANA INFOMRATION************
//#include "banana.h"
//************OLD DEPRACATED TEAPOT INFORMATION************
#include "Teapot.h"
//************ATAT INFORMATION*****************************
//#include "atat.h"
...
// DEPRECAT ON PURPOSE
unsigned int newTextureIndex	= 0;
...
// Constants:
//***********DEPRACATED TEAPOT INFORMATION************
static const float kObjectScale = 3.f;
//***********BANANA INFORMATION *************
//static const float kObjectScale = 200.f;
...
Java_com_qualcomm_QCARSamples_ImageTargets_ImageTargetsRenderer_renderFrame(JNIEnv *, jobject)
{
    ...
    for(int tIdx = 0; tIdx < state.getNumTrackableResults(); tIdx++)
    {
        ...
        int textureIndex = newTextureIndex;
        /**
        ...
        else if (strcmp(trackable.getName(), "EarthTarget1") == 0)
        {
        	textureIndex = 3;
        }
        else
...
//**************ATAT INFORMATION***************
//		// set input data to arrays
//		glVertexPointer(3, GL_FLOAT, 0, atatVerts);
//		glNormalPointer(GL_FLOAT, 0, atatNormals);
//		glTexCoordPointer(2, GL_FLOAT, 0, atatTexCoords);
//
//		// draw data
//		glDrawArrays(GL_TRIANGLES, 0, atatNumVerts);
...
//************BANANA INFORMATION************
//        glVertexAttribPointer(vertexHandle, 3, GL_FLOAT, GL_FALSE, 0,
//                              (const GLvoid*) &atatVerts[0]);
//        glVertexAttribPointer(normalHandle, 3, GL_FLOAT, GL_FALSE, 0,
//                              (const GLvoid*) &atatNormals[0]);
//        glVertexAttribPointer(textureCoordHandle, 2, GL_FLOAT, GL_FALSE, 0,
//                              (const GLvoid*) &atatTexCoords[0]);
...
JNIEXPORT void JNICALL
Java_com_qualcomm_QCARSamples_ImageTargets_ImageTargets_accelUpdate(
                            JNIEnv* env, jobject obj, jint newTarget)
{
    LOG("Java_com_qualcomm_QCARSamples_ImageTargets_ImageTargets_initApplicationNative");

    // Store new texture ID
    newTextureIndex = newTarget;
//
